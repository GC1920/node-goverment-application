...
export const updateNews = async (req, res) => {
    ...
    try {
        ...
        if (!title && !text && !banner) {
            ...
            res.status(400).send({ message: "Submit at least one field to submit!" });
        ...
        if (news.user.id != req.userId) {
            ...
            res.status(400).send({ message: "You can't update this post." });
...
export const eraseNews = async (req, res) => {
    ...
    try {
        ...
        if (news.user.id != req.userId) {
            ...
            res.status(400).send({ message: "You can't delete this post." });

        }
        
        await eraseService(id);

        return res.send({ message: "Post deleted sucesfully" });
...
export const addComment = async (req, res) => {
    ...
    try {
        ...
        res.send({ message: "Comment sucessfuly add!" });
...
export const deleteComment = async (req, res) => {
    ...
    try {
        ...
        res.send({ message: "Comment sucessfuly removed!" });
